...
const TransationsTable = ({ transactions, addTransaction }) => {
  ...
  let filteredTransactions =
    transactions.filter(item => item.name.toLowerCase().includes(search.toLowerCase()) && item.type.includes(typeFilter)
...
function importFromCsv(event){
  ...
  return ( <div style={{ width: "100%", padding: "0rem 2rem" }}>
      <div
        style={{
            width:'97%',
          display: "flex",
